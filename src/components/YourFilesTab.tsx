...
interface YourFilesTabProps {
  onDecryptFile?: (fileHash: string) => void;
}

export default function YourFilesTab({ onDecryptFile }: YourFilesTabProps) {
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  {onDecryptFile && (
                    <button
                      onClick={() => onDecryptFile(file.fileHash)}
                      className="p-2 text-[#3DA288] hover:bg-[#3DA288]/20 rounded-lg transition-colors"
              ...
              {file.blockchainTxHash && (
                <div className="mt-3 pt-3 border-t border-[#C0C8D4]/10">
