...
export const VoiceSignatureStep: React.FC<VoiceSignatureStepProps> = ({ onSaved }) => {
  ...
  // Check if voice signature already exists
  useEffect(() => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.user?.hasVoiceSignature) {
            ...
            // Notify parent that voice is already saved
            onSaved('already_saved');
          }
        }
      } catch (err) {
  ...
  if (isLoading) {
    return (
      <div className="max-w-2xl mx-auto text-center py-12">
        ...
        <p className="text-gray-400">Checking voice signature status...</p>
      </div>
    );
  }
  ...
  if (alreadySaved) {
    return (
      <div className="max-w-2xl mx-auto text-center">
        ...
        <h2 className="text-3xl font-bold text-white mb-4">Voice Signature Already Saved!</h2>
        <p className="text-gray-300 mb-2">
          Your voice signature is on file and ready for account recovery.
        </p>
        <p className="text-gray-400 text-sm mb-6">
          If your account gets frozen, you can use voice verification to unlock it.
        </p>
